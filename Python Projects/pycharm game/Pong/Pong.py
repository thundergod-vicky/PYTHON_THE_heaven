...
import pygame                                               # import progamme
import sys                                                  # import progamme
import random                                               # import progamme
from math import *                                          # import progamme

pygame.init()                                               # int inputs

width = 600
height = 400
display = pygame.display.set_mode((width, height))         # progamme visuals (balls)
pygame.display.set_caption("Pong!")
clock = pygame.time.Clock()

background = (27, 38, 49)
white = (236, 240, 241)
red = (203, 67, 53)                                       # customise visuals  (backgrounds)
blue = (52, 152, 219)
yellow = (244, 208, 63)

top = white
bottom = white
left = white                                              #  backgrounds of the bars to hit
right = white

margin = 4

scoreLeft = 0
scoreRight = 0                                            # scroll amount
maxScore = 20
