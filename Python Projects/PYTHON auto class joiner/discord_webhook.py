...
webhook_url = "https://discord.com/channels/578985330506596383/812682923902894091"
...
def send_msg(class_name, status, start_time, end_time):
    ...
    # Attaches a footer
    webhook.set_footer(text="-- NEROTHEPROGRAMMER")

    if status == "joined":

        webhook.set_content(
            title="Class Joined Succesfully",
